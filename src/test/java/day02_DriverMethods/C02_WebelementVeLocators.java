 ...
 */
        ...
        //Amazaon sayfasindaki <input> ve <a> taglarinin sayisini yazdiriniz
        List <WebElement> inputTag = driver.findElements(By.tagName("input"));
        System.out.println("Input tag sayisi: " + inputTag.size());//... adet input tagi ile baslayan webelement varmis
